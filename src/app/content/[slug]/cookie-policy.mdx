...
This Cookie Policy applies to our website at www.supremedao.xyz and sets out some further detail on how and why we use these technologies on our website. In this policy, "we", "us" and "our" refers to Daoism Systems UG incorporated in Germany with its registered office at Daoism Systems UG, c/o Full Node Skalitzer Str. 85/floor 3, 10997 Berlin, Germany. The terms “you” and “your” includes our clients, business partners and users of this website.By using our website, you consent to storage and access to cookies and other technologies on your device, in accordance with this Cookie Policy.
...
2.	persistent cookie which is saved to the hard drive and remains on the user's computer/device for a pre-defined period of time.
